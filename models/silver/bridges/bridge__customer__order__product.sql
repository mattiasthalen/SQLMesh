MODEL (
  name silver.bridge__customer__product,
  cron '@hourly',
  kind FULL,
  audits (
...
SELECT
  @generate_surrogate_key__sha_256(hub__customer.customer_hk, hub__order.order_hk, hub__product.product_hk) AS bridge_hk,
