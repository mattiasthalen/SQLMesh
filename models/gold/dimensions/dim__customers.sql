...
SELECT
  ...
  snapshot_valid_from AS customer__record_valid_from, /* Timestamp when the customer record became valid (inclusive) */
  snapshot_valid_to AS customer__record_valid_to /* Timestamp of when the customer record expired (exclusive) */
